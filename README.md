# TradeRunner v4.0 — Multi-tenant SaaS-ready (2026-05-28)

**«Беги к своей цели. Считай каждый трейд»** — журнал и аналитика крипто-сделок с биржи Bitunix.
...
└── ЗАПУСТИ_МЕНЯ_TradeRunner.bat   # Полный цикл: установка + запуск
```
...
1. **Не запускается** — проверь Python 3.10+ установлен. На Windows запусти `ЗАПУСТИ_МЕНЯ_TradeRunner.bat`
